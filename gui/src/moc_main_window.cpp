...
QT_MOC_LITERAL(1, 12, 21), // "connection_successful"
QT_MOC_LITERAL(2, 34, 0), // ""
QT_MOC_LITERAL(3, 35, 14), // "try_connection"
QT_MOC_LITERAL(4, 50, 23) // "update_flightcomp_state"

    },
    "main_window\0connection_successful\0\0"
    "try_connection\0update_flightcomp_state"
};
...
void main_window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->update_flightcomp_state(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&main_window::connection_successful)) {
                *result = 0;
                return;
            }
        }
